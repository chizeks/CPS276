        ...
        <form action="namelist.php" method="post">
           <label for="addName" class="form-label">Name</label>
             <div class="d-flex flex-row">
                <div class="px-1">
                <input type="submit" class="btn btn-success" name="addButton" id="submitButton" value="Add" />
                </div>
                <div class="px-1">
                <input type="submit" class="btn btn-success" name="clearButton" id="submitButton" value="Clear" />
                </div>
            </div>
